...
def build_specs(args):
    ...
    group1 = {k: v for k, v in group1.items() if v and args.__dict__[k.replace("-", "_")] > 0}
    group2 = {k: v for k, v in group2.items() if v and args.__dict__[k.replace("-", "_")] > 0}
