...
const std::vector<std::pair<Tickers, std::string>> TickersNameMap = {
    ...
    {NUM_FILES_COMPACTED_SO_FAR, "rocksdb.files.compacted.sofar"},
    ...
    {PARTIAL_FILE_FLUSH_COUNT, "rocksdb.partial.file.flush.count"},
    {PARTIAL_FILE_FLUSH_BYTES, "rocksdb.partial.file.flush.bytes"},
    {PARTIAL_GARBAGE_BYTES_AT_FLUSH, "rocksdb.partial.garbage.bytes.at.flush"},
    {FULL_FILE_FLUSH_COUNT, "rocksdb.full.file.flush.count"},
    {FULL_FILE_FLUSH_BYTES, "rocksdb.full.file.flush.bytes"},
    {FULL_GARBAGE_BYTES_AT_FLUSH, "rocksdb.full.garbage.bytes.at.flush"},
