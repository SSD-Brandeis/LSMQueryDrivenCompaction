...
enum Tickers : uint32_t {
  ...
  // Statistics for range reduce range query
  // Number of files flushed by RangeReduce
  RANGEREDUCE_FILE_FLUSH_COUNT,
  // Number of bytes flushed RangeReduce
  RANGEREDUCE_FILE_WRITE_BYTES,
