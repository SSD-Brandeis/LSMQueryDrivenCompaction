...
distributed across whole range query. It will end up with a scenario like shown in Figure~\ref{fig:query-driven_compaction_with_increased_writes}. \subhadeep{sample Figure caption.}
