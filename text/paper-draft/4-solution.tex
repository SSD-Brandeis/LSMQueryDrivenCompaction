...
have \textit{min\_key} (\textit{$x_i$}), \textit{max\_key} (\textit{$y_i$})%, and \textit{Total \# of entries} (\textit{$z_i$}) 
...
\begin{tabular}{|c|c|c|c|c|} %c|}
        ...
        L-0 & \-- & \-- & \-- & \-- \\ %\-- \\
        \hline
        L-1 & \textit{$E_{useful\ 1}$} & \textit{$E_{unuseful\ 1}$} & $x_{1}$ & $y_{1}$ \\ %& $z_{1}$ \\
        \hline
        L-2 & \textit{$E_{useful\ 2}$} & \textit{$E_{unuseful\ 2}$} & $x_{2}$ & $y_{2}$ \\ %$z_{2}$ \\
        \hline
        L-3 & \textit{$E_{useful\ 3}$} & \textit{$E_{unuseful\ 3}$} & $x_{3}$ & $y_{3}$ \\ %$z_{3}$ \\
        \hline
...
\begin{table}
    ...
    \begin{tabular}{|c|c|c|c|c|} %c|}
        ...
        L-0 & \-- & \-- & \-- & \-- \\ %\--\\
        \hline
        L-1 & 2K & 2K & $x_{1}$ & $y_{1}$ \\ %$z_{1}$ \\
        \hline
        L-2 & 5K & 3K & $x_{2}$ & $y_{2}$ \\ %$z_{2}$ \\
        \hline
        L-3 & 6.5K & 1.5K & $x_{3}$ & $y_{3}$ \\ %$z_{3}$ \\
        \hline
    \end{tabular}}
    \caption{Decision Making Data }
